...
export const HERO_PARALLAX_DEFAULTS: HeroParallaxSettings = {
  ...
  backgroundFactorDesktop: 0.4,
  backgroundFactorMobile: 0.25,
  backgroundMaxOffsetDesktop: 300,
  backgroundMaxOffsetMobile: 180,
  backgroundScaleDesktop: 1.25,
  backgroundScaleMobile: 1.1,
  contentFactorDesktop: 0.1,
  contentFactorMobile: 0.08,
  contentMaxOffsetDesktop: 80,
  contentMaxOffsetMobile: 60,
